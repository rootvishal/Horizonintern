...
import { Brain, Code2, BarChart3, TerminalSquare } from 'lucide-react';
...
const APPLY_URL =
  'https://docs.google.com/forms/d/e/1FAIpQLSf1Qw3rgi4aAFl7Rc1TCzd_ZSDrRlK6Ya-4hI1mniu7mz0qzA/viewform?usp=dialog';
...
const domains = [
  {
    ...
    icon: Code2,
    tasks: ['Build a responsive landing page', 'Create a small dashboard UI', 'Connect a simple API'],
  },
  {
    title: 'AI/ML',
    description: 'Prototype intelligent models and integrate them into products.',
    icon: Brain,
    tasks: ['Train a basic classifier', 'Build a simple prediction API', 'Write a short model report'],
  },
  {
    title: 'Python',
    description: 'Automate workflows, design data pipelines, and build services.',
    icon: TerminalSquare,
    tasks: ['Write a data cleanup script', 'Create a small REST API', 'Add basic unit tests'],
  },
  {
        ...
        <section id="domains" className="relative py-24">
          <div className="container mx-auto px-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-white/40">Available Domains</p>
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm">
              <Link
                ...
                className="rounded-full border border-cyan-300/40 bg-cyan-300/10 px-4 py-2 text-cyan-200 transition hover:bg-cyan-300/20"
              >
                AI/ML Internship Details
              </Link>
              <Link
                href="/internships/python"
                className="rounded-full border border-indigo-300/40 bg-indigo-300/10 px-4 py-2 text-indigo-200 transition hover:bg-indigo-300/20"
              >
                Python Internship Details
              </Link>
            </div>
        ...
        <section id="social-proof" className="py-12">
          <div className="container mx-auto px-6">
            <div className="glass-card p-6 sm:p-8">
              <h2 className="text-2xl font-semibold text-white">Build public proof and backlinks</h2>
              <p className="mt-3 max-w-3xl text-sm text-white/70 sm:text-base">
                After submitting projects, share your Horizon Intern work on LinkedIn and GitHub with a
                link back to this site. This grows your profile and strengthens search authority for
                future cohorts.
              </p>
            </div>
          </div>
